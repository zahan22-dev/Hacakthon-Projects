...
var generateResume = function (event) {
    ...
    var resumeContent = "\n        <h2>Generated Resume</h2>\n        <p><strong><span contenteditable=\"true\">Name:</span></strong> ".concat(name, "</p>\n        <p><strong><span contenteditable=\"true\">Email:</span></strong> ").concat(email, "</p>\n        <p><strong><span contenteditable=\"true\">Phone:</span></strong> ").concat(phone, "</p>\n        <h3>Education</h3>\n        <p contenteditable=\"true\">").concat(education, "</p>\n        <h3>Work Experience</h3>\n        <p contenteditable=\"true\">").concat(workExperience, "</p>\n        <h3>Skills</h3>\n        <p contenteditable=\"true\">").concat(skills, "</p>\n    ");
